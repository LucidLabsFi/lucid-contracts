...
///
/// @author Oighty
abstract contract BondBaseFPA is IBondFPA, Context, Auth {
    ...
    function _createMarket(MarketParams memory params_) internal returns (uint256) {
        ...
        uint256 _maxPayout = (params_.capacityInQuote ? params_.capacity.mulDiv(scale, params_.formattedPrice) : params_.capacity).mulDiv(
