...
/// @dev Mock contract for XERC20Lockbox with a non-standard withdraw function
contract XERC20LockboxNoWithdrawMock {
    ...
    function withdrawAltered(uint256 _amount) external {
