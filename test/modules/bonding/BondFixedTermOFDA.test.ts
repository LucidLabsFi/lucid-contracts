...
describe("BondFixedTermOFDA Tests", () => {
    ...
    beforeEach(async () => {
        vestingLength = 86400; // 1 day. Since market is fixed term, vesting is vesting length in seconds
    ...
    describe("Fixed-term market", () => {
        beforeEach(async () => {
            ...
            // Set the price feed
            await priceFeed1.setLatestAnswer(ethers.utils.parseEther("0.25"));
